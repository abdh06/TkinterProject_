...
def open_game_window():
    ...
    game_window.iconbitmap(resource_path("Images/Happy.ico"))  # Set the window icon

    def start_game():
        game_window.iconbitmap(resource_path("Images/Happy.ico"))  # Set the window icon to happy face
    ...
    def reset_game():
        game_window.iconbitmap(resource_path("Images/sad.ico"))  # Change the window icon to sad face
...
root.iconbitmap(resource_path("Images/Happy.ico"))  # Set the window icon

# Load the background image
bg_image = Image.open(resource_path("Images/Emojis.jpg"))  # Open the image
...
root.mainloop()  # Start the application on main loop to exit only when needed.
